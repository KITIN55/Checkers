...
class Game:
    ...
    def take_move_input(self, player):
        ...
        while True:
            inpt = self.__int_input("What piece would you like to move? (Give the corresponding index)",
            ...
            coord_index = self.__int_input("Pick one of these possible positions your piece can move to.",
